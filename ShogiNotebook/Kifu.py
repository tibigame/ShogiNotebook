...
from ShogiNotebook.PieceDistribution import PieceDistribution
from ShogiNotebook.PieceDistribution import get_piece_value
...
class Kifu:
    ...
    def __move_stat(self, m_d: MoveDetail, info, progress):
